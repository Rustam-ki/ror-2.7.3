...
users = User.create!([
                        { first_name: 'Рустам', last_name: 'Киньябаев', email: 'qwertrondell@gmail.com', password: 'ssssss', type: 'Admin' },
                    ])
...
tests = Test.create!([
                       { title: 'HTML', level: 3, category_id: categories[0].id, author: users[0]},
                       { title: 'CSS', level: 2, category_id: categories[0].id, author: users[0]},
                       { title: 'JS', level: 1, category_id: categories[1].id, author: users[0]},
                       { title: 'PHP', level: 1, category_id: categories[1].id, author: users[0]},
                       { title: 'Java', level: 3, category_id: categories[1].id, author: users[0]}
                     ])
