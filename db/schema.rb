...
ActiveRecord::Schema.define(version: 2021_11_28_160116) do
  ...
  create_table "user_performed_tests", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["test_id"], name: "index_user_performed_tests_on_test_id"
    t.index ["user_id"], name: "index_user_performed_tests_on_user_id"
  end
